            ...
            { new IGitea with
                    ...
                    async {
                        ...
                        let uri =
                            System.Uri(
                                ...
                                System.Uri(
                                    ("admin/unadopted"
                                     + (if "admin/unadopted".IndexOf(char 63) >= 0 then "&" else "?")
                                       + "page="
                                       + ((page.ToString()) |> System.Uri.EscapeDataString)
                                       + "&limit="
                                       + ((limit.ToString()) |> System.Uri.EscapeDataString)
                ...
                member _.RepoListAllGitRefs
                    ...
                    async {
                        ...
                        return jsonNode.AsArray() |> Seq.map (fun elt -> Reference.jsonParse elt) |> List.ofSeq
                    }
                    |> (fun a -> Async.StartAsTask(a, ?cancellationToken = ct))
                ...
                member _.RepoListKeys
                    ...
                    async {
                        ...
                        return jsonNode.AsArray() |> Seq.map (fun elt -> DeployKey.jsonParse elt) |> List.ofSeq
                    }
                    |> (fun a -> Async.StartAsTask(a, ?cancellationToken = ct))
                ...
                member _.IssueGetMilestonesList
                    ...
                    async {
                        ...
                        return jsonNode.AsArray() |> Seq.map (fun elt -> Milestone.jsonParse elt) |> List.ofSeq
                    }
                    |> (fun a -> Async.StartAsTask(a, ?cancellationToken = ct))
                ...
                member _.UserCurrentListKeys
                    ...
                    async {
                        ...
                        return jsonNode.AsArray() |> Seq.map (fun elt -> PublicKey.jsonParse elt) |> List.ofSeq
                    }
                    |> (fun a -> Async.StartAsTask(a, ?cancellationToken = ct))
                ...
                member _.UserGetStopWatches(page: int, limit: int, ct: System.Threading.CancellationToken option) =
                    async {
                        ...
                        return jsonNode.AsArray() |> Seq.map (fun elt -> StopWatch.jsonParse elt) |> List.ofSeq
                    }
                    |> (fun a -> Async.StartAsTask(a, ?cancellationToken = ct))
